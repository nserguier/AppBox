...
public class AnimatedText{
	...
	/**
	 * Cree un texte avec une animation de vague
	...
	/**
	 * Cree un texte avec une animation de vague
	 * toutes les lettres ont la même couleur
	 * @param context
	 * @param layout
	 * @param myText
	 * @param color
	 * @param textSize
	 */
	public static void add(Context context,LinearLayout layout,String myText,int color,float textSize){
