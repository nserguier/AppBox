...
public class Bluetooth
{
 ...
 // Constants that indicate the current connection state
    ...
    /** The connected thread performs wrinting and reading when a connection is established. */
    ...
    private synchronized void setState(final int state)
    {
        ...
        mHandler.obtainMessage(Bluetooth_Constants.MESSAGE_STATE_CHANGE, state, -1)
            .sendToTarget();
    }
    ...
    /**
     * Start the ConnectThread (client) to initiate a connection to a remote device.
     * @param device The BluetoothDevice to connect
     * @param secure Socket Security type - Secure (true) , Insecure (false)
     * device is null in case of network connection or if bluetooth is not enabled on
     * the Smartphone.
     */
    ...
    /**
     * Start the ConnectedThread (input and output streams are managed here)
     * to begin managing a Bluetooth connection
     * @param socket The BluetoothSocket on which the connection was made
     * @param device The BluetoothDevice that has been connected
     */
    private synchronized void connected(final BluetoothSocket socket, final BluetoothDevice device,
        final String socketType)
    {
        ...
        final Message msg = mHandler.obtainMessage(Bluetooth_Constants.MESSAGE_DEVICE_NAME);
     ...
     * @param mes l'emploi du temps a ecrire
    ...
    private void connectionFailed()
    {
        ...
        final Message msg = mHandler.obtainMessage(Bluetooth_Constants.MESSAGE_TOAST);
        final Bundle bundle = new Bundle();
        bundle.putString(Bluetooth_Constants.TOAST, "Impossible de se connecter a un appareil");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        setState(STATE_NONE);
    ...
    private void connectionLost()
    {
        ...
        final Message msg = mHandler.obtainMessage(Bluetooth_Constants.MESSAGE_TOAST);
        final Bundle bundle = new Bundle();
        bundle.putString(Bluetooth_Constants.TOAST, "La connexion avec l'appareil a ete perdue");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        setState(STATE_NONE);
        // Start the service over to restart listening mode
    ...
    private class ConnectedThread extends Thread
    {
         ...
         * @param buffer The WatchMessage to write
         */
