...
public class FabriqueMenu {
	...
	public static Menu create(TypeMenu typeMenu, Context context)
		...
		switch (typeMenu) {
		case JungleHorizontal:
			return new MenuJungleH(context);
		case JungleVertical:
			return new MenuJungleV(context);
		case OceanHorizontal:
			return new MenuOceanH(context);
		case Options:
			return new MenuOptions(context);
		}
