...
public class MenuOceanH implements Menu {
	...
	public void animation() {
		...
		RelativeLayout.LayoutParams sm_params = new LayoutParams(height / 3
				+ height / 10, height / 3 + height / 10);
		...
		RelativeLayout.LayoutParams em_params = new LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		...
		em.setBackground(context.getApplicationContext().getResources()
		...
		RelativeLayout.LayoutParams b_params = new LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		...
		bulles.setBackground(context.getApplicationContext().getResources()
